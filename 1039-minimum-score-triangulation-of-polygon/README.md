...
<pre style="position: relative;"><strong>Input:</strong> values = [1,2,3]
...
<pre style="position: relative;"><strong>Input:</strong> values = [3,7,4,5]
...
<pre style="position: relative;"><strong>Input:</strong> values = [1,3,1,4,1,5]
