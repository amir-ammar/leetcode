...
<pre style="position: relative;"><strong>Input:</strong> rolls = [3,2,4,3], mean = 4, n = 2
...
<pre style="position: relative;"><strong>Input:</strong> rolls = [1,5,6], mean = 3, n = 4
...
<pre style="position: relative;"><strong>Input:</strong> rolls = [1,2,3,4], mean = 6, n = 4
